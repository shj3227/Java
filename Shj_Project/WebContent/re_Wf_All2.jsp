...
<!-- 글쓰기 폼 시작 -->
    ...
    <form name="p_Write" action="write.do" method="post">
    <div id="wrap">
    <div class="container">
            <div id="contents">
              <select id="cate_1" name="cate_1" >
			  <!-- onchange="changeCate(this, 1)" 이 부분에서 에러남. 대체 왜나는지 모름. -->
			  <!-- <select id="cate_1" name="cate_1" onchange="changeCate(this, 1)"> 원본-->
              ...
              <select id="cate_3" name="cate_3">
              <option selected="selected">삽니다</option>
              <option>팝니다</option>
				...
				<br>
              <input type="text" id="Wfc1" name="title" placeholder="글 제목을 입력하세요." />
           
            
         
            
            <div class="form-inline">
                <textarea id="txt" class="form-control" name="contents"
                  style="width: 400px; resize: none" rows="5">
                   <h3>해당 양식에 따라 글을 작성해주십시오.</h3>
                   <br>
                   ---------------------------------------------------------------------------------
                   <br>
                   <b>상품명:
            ...
            <hr />
            <div align="center">
				<input id="w_submit" class="success" onclick="writeSubmit()" type="button" value="완료">
                <input id="w_list" class="primary" type="button" onclick="showlist()" value="글목록">
            </div>
...
<!-- 글쓰기 폼 끝 -->
<%@ include file="re_Wf_All_Addon.jsp" %>
<!-- Sideright 시작-->
<div id="sideright">
