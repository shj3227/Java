...
<div id="container">
	...
	<fieldset>
		...
		<!-- 폼 등록. css에 영향이 있는지 없는지 몰라서 일단 적어둠 -->
		<span>ID</span>	
		...
		if(request.getParameter("userID") != null)
		{
			...
			out.print("<input name=\"userID\" type=\"hidden\" value=\"\">");
			out.print("<input name=\"userName\" type=\"hidden\" value=\"\">");
		}
		%>
		<!-- 여기까지 임시 추가분. -->
	
	<button class="log_button" type="button" onclick ="loginSubmit()">Log In</button> 
	<!-- 링크 추가 + 클래스 추가 -->
	
	</form>
	<ul>
		<li><a href="FindId.jsp"> - Search Id</a></li>
		<li><a href="FindPw.jsp"> - Search Password</a></li>
	</ul>
	<p class="join_btn">
		<a href="menu_plus_join.jsp">JOIN MEMBER</a>
	</p>
	<%@ include file="Login_Addon.jsp" %>
		</div>
