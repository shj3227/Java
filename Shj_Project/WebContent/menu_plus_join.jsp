...
<div id="contents-join">
	...
	<br>
	<form class="join-frm" name = "join" action="insert.do" method = "post">
    ...
    <tbody>
      <tr>
        ...
        <td>     
		 ...
		 <button class="joinc5" type="button" onclick="loadData()">중복체크</button>
		 <!-- 버튼에 대한것도 만들어 줄것. -->
		</td>
      </tr>
      ...
      <tr>
       ...
       <tr>
        ...
        <td>     
		 <input class="joinc6" name="email" type="text" value=""> @ <input class="joinc6" id="selectIdInput" name="email" type="text" value=""> 
			<select id="selectID">
       ...
       <tr>
		...
		<input class="joinc3" onclick="sample3_execDaumPostcode()" type="button" value="우편번호 찾기" >
